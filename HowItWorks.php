    ...
    <header class="bg-gray-900 text-white fixed w-full z-50">
        <div class="flex justify-between items-center px-6 py-4">
            ...
            <nav id="desktop-nav" class="hidden md:flex items-center space-x-6">
                ...
                <?php else: ?>
                    <!-- Guest -->
                    <a href="login.php" class="bg-primary-900 hover:bg-primary-800 px-4 py-2 rounded-lg">Log In</a>
                    <a href="signup.php" class="bg-primary-500 hover:bg-primary-600 px-4 py-2 rounded-lg">Sign Up</a>
                <?php endif; ?>
            </nav>
        </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div id="story-step-1" class="grid md:grid-cols-2 gap-20 items-center mb-32 opacity-0 translate-y-10" data-aos="fade-up">
                ...
                <div class="space-y-8 order-1 md:order-2">
                    ...
                    <h3 class="text-4xl font-bold text-white">Find Your Perfect Ride</h3>
                    <p class="text-xl text-gray-400">Open the app and discover available bikes near you. Our smart map
                        shows real-time Noleggio and bike types.</p>
                </div>
            </div>
            <!-- Step 2: Unlock -->
            <div id="story-step-2" class="grid md:grid-cols-2 gap-20 items-center mb-32 opacity-0 translate-y-10" data-aos="fade-up">
                <div class="space-y-8 order-2 md:order-1">
                    ...
                    <h3 class="text-4xl font-bold text-white">Quick Unlock</h3>
                    <p class="text-xl text-gray-400">Simply scan the QR code on your chosen bike. Our secure system
                        instantly verifies and unlocks your ride.</p>
                </div>
                <div class="relative h-[500px] overflow-hidden rounded-3xl order-2 md:order-1">
            ...
            <div id="story-step-3" class="grid md:grid-cols-2 gap-20 items-center mb-32 opacity-0 translate-y-10" data-aos="fade-up">
                ...
                <div class="space-y-8 order-1 md:order-2">
                    ...
                    <h3 class="text-4xl font-bold text-white">Enjoy Your Ride</h3>
                    <p class="text-xl text-gray-400">Hit the streets with confidence. Our bikes are regularly maintained
                        and
                        equipped with safety features.</p>
                </div>
            </div>
            ...
            <div id="story-step-4" class="grid md:grid-cols-2 gap-20 items-center opacity-0 translate-y-10" data-aos="fade-up">
                <div class="space-y-8 order-2 md:order-1">
                    ...
                    <h3 class="text-4xl font-bold text-white">Easy Return</h3>
                    <p class="text-xl text-gray-400">Park at any designated spot, lock your bike, and end the ride in
                        the
            ...
            <div class="grid grid-cols-2  gap-8 mb-12">
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><span class="text-gray-400 hover:text-primary-400 transition-colors cursor-pointer"><a href="#">Noleggio</a></span></li>
