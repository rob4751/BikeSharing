    ...
    <header class="bg-gray-900 text-white fixed w-full z-50">
        <div class="flex justify-between items-center px-6 py-4">
            ...
            <nav id="desktop-nav" class="hidden md:flex items-center space-x-6">
                ...
                <a href="#" class="hover:text-primary-400">Noleggio</a>
            ...
            function addBikeMarkers() {
                ...
                bikeLocations.forEach(loc => {
                    ...
                    const popupContent = `
                        ...
                        <a href="pagamento.php" class="mt-2 inline-block bg-primary-500 hover:bg-primary-600 text-white px-3 py-1 rounded">Noleggia ora</a>
                        </div>
                    `;
